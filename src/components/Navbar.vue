    ...
    <nav :class="changeColorOnScroll"
        ...
        <div :class="changeColorOnToggle"
            ...
            <div id="nav" :class="show === false ? 'hidden' : 'block'"
                 class="flex-auto items-center mt-2 mb-2 rounded-lg md:flex grow md:mt-0 md:bg-transparent md:rounded-none">
                <ul class="flex flex-col justify-center mr-auto w-full text-lg font-bold text-white md:flex-row">
                    <li class="flex">
                        <a class="p-4 w-full text-left" href="#home">Home</a>
                    </li>
                    <li class="flex">
                        <a class="p-4 w-full text-left" href="#about">About</a>
                    </li>
                    <li class="flex">
                        <a class="p-4 w-full text-left" href="#">Blog</a>
                    </li>
                    <li class="flex">
                        <a class="p-4 w-full text-left" href="#services">Services</a>
                    </li>
                    <li class="flex">
                        <a class="p-4 w-full text-left" href="#contact">Contact</a>
                    </li>
                </ul>
